---
layout: program-doc
title: "How to Verify — Physicist Route"
permalink: /verify/how-to-verify-by-role/physicist/
lane: verify
v2_lane: verify
...
If the audit is positive and you want to go deeper, the next route depends on interest: [Mathematician route]({{ '/verify/how-to-verify-by-role/mathematician/' | relative_url }}) for the derivation-machinery foundations, or [Prior-Art Specialist route]({{ '/verify/how-to-verify-by-role/prior-art-specialist/' | relative_url }}) for the no-dark-sectors / three-generation comparison.
