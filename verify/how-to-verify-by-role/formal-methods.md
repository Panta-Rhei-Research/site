---
layout: program-doc
title: "How to Verify — Formal Methods / Proof Assistant Route"
permalink: /verify/how-to-verify-by-role/formal-methods/
lane: verify
v2_lane: verify
...
- For claims in Books IV–V: [Physicist route]({{ '/verify/how-to-verify-by-role/physicist/' | relative_url }})
- For claims in Books VI–VII: [Philosopher route]({{ '/verify/how-to-verify-by-role/philosopher/' | relative_url }})
- For specialist-level claims: [Mathematician route]({{ '/verify/how-to-verify-by-role/mathematician/' | relative_url }}) and [Prior-Art Specialist route]({{ '/verify/how-to-verify-by-role/prior-art-specialist/' | relative_url }})
