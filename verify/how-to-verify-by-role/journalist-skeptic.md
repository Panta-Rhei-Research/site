---
layout: program-doc
title: "How to Verify — Journalist / Skeptic / Generalist Route"
permalink: /verify/how-to-verify-by-role/journalist-skeptic/
lane: verify
v2_lane: verify
...
- **If you have a specific technical background,** take the corresponding route: [formal methods]({{ '/verify/how-to-verify-by-role/formal-methods/' | relative_url }}), [mathematician]({{ '/verify/how-to-verify-by-role/mathematician/' | relative_url }}), [physicist]({{ '/verify/how-to-verify-by-role/physicist/' | relative_url }}), [philosopher]({{ '/verify/how-to-verify-by-role/philosopher/' | relative_url }}), or [prior-art specialist]({{ '/verify/how-to-verify-by-role/prior-art-specialist/' | relative_url }}).
