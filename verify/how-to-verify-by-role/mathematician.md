---
layout: program-doc
title: "How to Verify — Mathematician Route"
permalink: /verify/how-to-verify-by-role/mathematician/
lane: verify
v2_lane: verify
...
- **"Earned from seven axioms" claim.** The framework states its mathematical content is earned from the kernel, not imported from Mathlib. Confirm this at the Lean level (see [Formal Methods route]({{ '/verify/how-to-verify-by-role/formal-methods/' | relative_url }})).
...
- For physical interpretation of the mathematics: [Physicist route]({{ '/verify/how-to-verify-by-role/physicist/' | relative_url }})
- For prior-art overlap assessment: [Prior-Art Specialist route]({{ '/verify/how-to-verify-by-role/prior-art-specialist/' | relative_url }})
...
- [How to Verify by Reviewer Role]({{ '/verify/how-to-verify-by-role/' | relative_url }}) — all six reviewer routes
