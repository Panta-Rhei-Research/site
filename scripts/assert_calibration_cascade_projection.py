...
def main() -> int:
    ...
    for filename in ("index.json", "constants-ledger.json", "coupling-ledger.json"):
    ...
    assert_contains(route, "constants ledger is rendered as a table of outputs", "source route")
