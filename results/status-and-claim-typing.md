...
Precision tiers also depend on the cascade layer (see the [Calibration Cascade]({{ '/results/calibration-cascade/' | relative_url }}) for the L0 → L4 dependency overlay). L1 dimensionless results tend to sit at the sharpest end of the tier distribution; L3 SI readout / unit realization results carry whatever the anchor and unit context allow.
