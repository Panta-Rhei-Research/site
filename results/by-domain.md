...
Numerical results in Physics and Mathematics additionally sit at a specific layer of the **calibration cascade** (L0 algebra · L1 dimensionless · L2 anchor · L3 SI-anchored · L4 verification) and carry a precision tier (**A** ~0.025 ppm · **B** ~3 ppm · **C** ~0.8%). See the [Claims overview]({{ '/results/' | relative_url }}#the-calibration-cascade--the-logical-spine-of-the-claims-lane) for the architectural spine, or the [Physics Ledger]({{ '/publications/physics-ledger/' | relative_url }}#ch-58a) Ch 58a for the full Calibration Sufficiency Theorem.
