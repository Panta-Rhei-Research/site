...
<div class="notice note"><strong>Boundary note.</strong> This page is not an accountability mirror. Declared open-problem obligations belong to [Problem Answers]({{ '/results/problem-ledger-answers/' | relative_url }}), and declared recovery obligations belong to [Core Semantics Status]({{ '/results/core-semantics-status/' | relative_url }}).</div>
