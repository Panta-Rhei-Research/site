...
nav_order: 1
summary_short: "The epistemic front door to the Results lane — what counts as a result, how the framework first exists as a claim-bearing object."
right_rail:
  related:
...
After the world readouts, the [detailed claim atlas]({{ '/results/browse/' | relative_url }}) presents 234 individual claims with typed epistemic status.
...
These pages are written as interpretive and epistemic clarifications, not as theorem ledgers. They aim to make explicit what is already distributed across the [books]({{ '/publications/' | relative_url }}), the [framework modules]({{ '/framework/' | relative_url }}), [TauLib]({{ '/verify/' | relative_url }}), and the [claim corpus]({{ '/results/browse/' | relative_url }}).
