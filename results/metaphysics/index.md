...
- [Metaphysics Glossary]({{ '/results/metaphysics/glossary/' | relative_url }}) — all {% include release-metric.html id="glossary.metaphysics.entries" %} entries grouped by category
