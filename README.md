...
The program is published as a canonical monograph series with a free **Numerical Physics Ledger** companion and manifest-pinned Corpus, Results, and Verify surfaces. Current release-changing numbers are generated from the Corpus release manifest below by Site Atlas rather than hand-owned in README prose.
