...
title: Life Layer
lane: framework
section: framework-life
summary_short: 'Layer E₂ defines life through two categorical predicates: Distinction
  (self/non-self boundary) and SelfDesc (internal ev...'
summary_cards:
- title: Layer
  body: E2 — Life
- title: Modules
  body: 8 framework modules
- title: Books
  body: Book VI
right_rail:
  related:
...
Layer E₂ defines life through two categorical predicates: Distinction (self/non-self boundary) and SelfDesc (internal evaluator). From this conjunction, all seven classical hallmarks follow as theorems.
