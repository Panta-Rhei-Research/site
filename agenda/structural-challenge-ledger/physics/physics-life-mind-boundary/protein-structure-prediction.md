...
- domain_semantics
summary_short: Protein structure prediction — see briefing 01 §7 for full structural
  framing.
lane: agenda
v2_lane: agenda
...
status: Canonical
permalink: /agenda/structural-challenge-ledger/physics/physics-life-mind-boundary/protein-structure-prediction/
tags:
...
reviewer_questions:
- Does τ produce extensional results for Protein structure prediction?
...
v1_problem_ledger_item_id: phys-protein-structure-prediction
challenge_statement: Protein structure prediction — see briefing 01 §7 for full structural
  framing.
tau_burden: ''
current_response: ''
...
Migrated from v1 problem-ledger entry `phys-protein-structure-prediction`. Per briefing 01 §7, classified as ring `R6_cross_domain_handoff` in cluster `physics-life-mind-boundary` with physics-core-weight `boundary`.
