...
- domain_semantics
summary_short: Dark flow — see briefing 01 §7 for full structural framing.
lane: agenda
v2_lane: agenda
section: structural-challenge-ledger
type: Structural Challenge
status: Canonical
permalink: /agenda/structural-challenge-ledger/physics/cosmology-dark-sector/dark-flow/
tags:
...
reviewer_questions:
- Does τ produce extensional results for Dark flow?
...
v1_problem_ledger_item_id: phys-dark-flow
challenge_statement: Dark flow — see briefing 01 §7 for full structural framing.
tau_burden: ''
current_response: ''
...
Migrated from v1 problem-ledger entry `phys-dark-flow`. Per briefing 01 §7, classified as ring `R5_peripheral_observational` in cluster `cosmology-dark-sector` with physics-core-weight `peripheral`.
