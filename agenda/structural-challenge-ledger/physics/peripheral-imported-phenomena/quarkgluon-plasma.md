...
- domain_semantics
summary_short: Quark–gluon plasma — see briefing 01 §7 for full structural framing.
lane: agenda
v2_lane: agenda
section: structural-challenge-ledger
type: Structural Challenge
status: Canonical
permalink: /agenda/structural-challenge-ledger/physics/peripheral-imported-phenomena/quarkgluon-plasma/
tags:
...
reviewer_questions:
- Does τ produce extensional results for Quark–gluon plasma?
...
v1_problem_ledger_item_id: phys-quarkgluon-plasma
challenge_statement: Quark–gluon plasma — see briefing 01 §7 for full structural framing.
tau_burden: ''
current_response: ''
...
Migrated from v1 problem-ledger entry `phys-quarkgluon-plasma`. Per briefing 01 §7, classified as ring `R5_peripheral_observational` in cluster `peripheral-imported-phenomena` with physics-core-weight `peripheral`.
