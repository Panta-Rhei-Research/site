...
layer: E1
strand: macrocosm
summary_short: r = ι<sub>τ</sub>⁴, n_s = 0.9649, ℓ₁ = 220.6 — all from one constant.
diagrams:
...
thesis: The CMB power spectrum is derived from ι<sub>τ</sub> alone; tensor-to-scalar ratio pre-registered
  for CMB-S4.
canonical_books:
- V
source_parts:
