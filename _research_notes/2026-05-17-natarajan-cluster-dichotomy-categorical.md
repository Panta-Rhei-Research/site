---
title: "The Natarajan Dichotomy as One D-Sector Readout in Two Regimes"
subtitle: "A τ-Categorical Pre-Registration against the Natarajan, Chiang & Dutra (2026) Multiscale Cluster-Lensing CDM Crisis"
slug: "natarajan-cluster-dichotomy-categorical"
permalink: /publications/research-notes/natarajan-cluster-dichotomy-categorical/
date: 2026-05-17
type: "Research Note"
...
secondary_domains:
  ...
  - Gravitation
  - Dark Matter
summary_short: "A τ-categorical pre-registration response to Natarajan, Chiang & Dutra's (2026) multiscale-cluster-lensing CDM-crisis paper, with three τ-distinctive readings, one numerical anchor, and an 11-row N16 falsification surface."
summary: "This Research Note reads the Natarajan dichotomy (the apparent need for the same cluster-member subhalos to be collisional in cores and collisionless in outskirts) as one D-sector readout in two regimes, not two DM components."
abstract: "Natarajan, Chiang & Dutra (2026, ApJL 1001, L12) report a new cold-dark-matter crisis from multiscale gravitational lensing of three massive clusters (MACS J0416, J1206, J1149) compared to TNG-Cluster ΛCDM analogs. Four substructure diagnostics yield a dichotomy: the same member-galaxy subhalos must carry steep inner density slopes (core-collapsed SIDM-like) and collisionless-CDM-like outer tidal extents. We pre-register a Category-τ reading as one D-sector readout in two regimes, with three τ-distinctive positive readings (outer Newtonian-limit r_t; inner M∂(R) number-promotion; transition r_trans ≈ 3.4–10.8 kpc), and an 11-row N16 falsification surface. Headline pre-registered falsifier: host-mass independence of r_trans at fixed SHMF, testable with Euclid + Rubin LSST + JWST/Roman by ~2029. Three derivational gaps are flagged honestly; the inner-density-slope-direction tension is reframed as a count-axis-vs-slope-axis discriminator in GGSL+kinematics joint inference."
anchor_paper: "Natarajan, P., Chiang, B. T., Dutra, I., 2026, ApJL 1001, L12, 'New Cold Dark Matter Crisis Revealed by Multiscale Cluster Lensing' (doi:10.3847/2041-8213/ae53ea)"
anchor:
  title: "New Cold Dark Matter Crisis Revealed by Multiscale Cluster Lensing"
  description: "Natarajan, Chiang & Dutra report a multiscale strong+weak gravitational lensing analysis of three relaxed massive clusters; four substructure diagnostics yield a dichotomy that no single particle-DM microphysics satisfies."
  relation: "Engaged as the anchor paper. The τ-program offers a non-particle Category-τ reading as a pre-registration, not as an adjudication."
external_links:
...
verification:
  ...
  mode: "categorical-pre-registration"
  routes:
...
topics:
  ...
  - boundary-holonomy mass
  - M∂(R) inner-promotion
  - cluster screening factor
  - capacity-gradient gravity
  - Category τ
  - SHMF
  - GGSL probability
keywords:
